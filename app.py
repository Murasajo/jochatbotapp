...
#nltk.download('punkt')
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql+psycopg2://murasa:2cwwGUiSJoPkquYVhy46cx2YocCgMWAa@dpg-cf2mal14reb5o469b3u0-a.oregon-postgres.render.com/chatbot_sw1n"
db = SQLAlchemy(app)
CORS(app)
## Database
